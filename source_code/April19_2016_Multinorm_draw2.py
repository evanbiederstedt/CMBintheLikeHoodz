...
draw_points_600 = np.asarray([[LogLF_twoargs(cell_array[i], draws[j]) for i in range(200)] for j in np.arange(500,600)])


# In[ ]:

f6A = "draw_points_600_twohundredXX.npy"
np.save(f6A, draw_points_600)
...
draw_points_700 = np.asarray([[LogLF_twoargs(cell_array[i], draws[j]) for i in range(200)] for j in np.arange(600,700)])



# In[ ]:

f7A = "draw_points_700_twohundredXX.npy"
np.save(f7A, draw_points_700)
...
draw_points_800 = np.asarray([[LogLF_twoargs(cell_array[i], draws[j]) for i in range(200)] for j in np.arange(700,800)])


# In[ ]:

f8A = "draw_points_800_twohundredXX.npy"
np.save(f8A, draw_points_800)
...
draw_points_900 = np.asarray([[LogLF_twoargs(cell_array[i], draws[j]) for i in range(200)] for j in np.arange(800,900)])


# In[ ]:

f9A = "draw_points_900_twohundredXX.npy"
np.save(f9A, draw_points_900)
...
draw_points_1000 = np.asarray([[LogLF_twoargs(cell_array[i], draws[j]) for i in range(200)] for j in np.arange(900,1000)])


# In[ ]:

f10A = "draw_points_1000_twohundredXX.npy"
np.save(f10A, draw_points_1000)
